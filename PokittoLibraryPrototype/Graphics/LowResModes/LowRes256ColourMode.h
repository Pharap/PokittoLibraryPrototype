...
namespace Pokitto
{
	/// A non-instantiable class representing the standard 256-colour, 8 bits per pixel, 110x88 display mode.
	class LowRes256ColourMode
	{
	public:
	...
	public:
		...
		static constexpr std::size_t colourCount = 256;

		/// The number of bits used per pixel.
		static constexpr std::size_t bitsPerPixel = 8;
	...
	public:
		...
		//static void drawTriangle(int x0, int y0, int x1, int y1, int x2, int y2, IndexType colourIndex);
		//static void fillTriangle(int x0, int y0, int x1, int y1, int x2, int y2, IndexType colourIndex);
		
		//static void drawRoundedRectangle(int x, int y, std::size_t width, std::size_t height, unsigned int radius, IndexType colourIndex);
		//static void fillRoundedRectangle(int x, int y, std::size_t width, std::size_t height, unsigned int radius, IndexType colourIndex);

...
namespace Pokitto
{
	/// A non-instantiable class representing the standard 16-colour, 4 bits per pixel, 220x176 display mode.
	class HighRes16ColourMode
	{
	public:
	...
	public:
		...
		static constexpr std::size_t displayWidth = Display::screenWidth;

		/// The vertical resolution of this display mode.
		static constexpr std::size_t displayHeight = Display::screenHeight;
		...
		static constexpr std::size_t colourCount = 16;

		/// The number of bits used per pixel.
		static constexpr std::size_t bitsPerPixel = 4;
